...
\begin{figure}[t!]
  ...
  \subfloat[Bunching in Year 1]{
    \includegraphics[width=60mm]{graphs/BunchingYear1_1Million_Degree4_30000}
    \label{fig:LowestThreshold-A}
  }
  \subfloat[Bunching in Year 2]{
    \includegraphics[width=60mm]{graphs/BunchingYear2_1Million_Degree4_30000}
    \label{fig:LowestThreshold-B}
  }
  \hspace{0mm}
  \subfloat[No Bunching in Year 3]{
    \includegraphics[width=60mm]{graphs/BunchingYear3_1Million_Degree4_30000}
    \label{fig:LowestThreshold-C}
  }
  \subfloat[No Bunching in Year 4]{
    \includegraphics[width=60mm]{graphs/BunchingYear4_1Million_Degree4_30000}
    \label{fig:LowestThreshold-D}
  }
  \hspace{0mm}
  \subfloat[No Bunching in Year 5]{   
    \includegraphics[width=60mm]{graphs/BunchingYear5_1Million_Degree4_30000}
...
\begin{figure}[t!]
  \centering
  \subfloat[Bunching in Year 1]{
    \includegraphics[width=60mm]{graphs/BunchingYear1_5Million_Degree4_30000}
    \label{fig:MiddleThreshold-A}
  }
  \subfloat[Bunching in Year 2]{
    \includegraphics[width=60mm]{graphs/BunchingYear2_5Million_Degree4_30000}
    \label{fig:MiddleThreshold-B}
  }
  \hspace{0mm}
  \subfloat[No Bunching in Year 3]{
    \includegraphics[width=60mm]{graphs/BunchingYear3_5Million_Degree4_30000}
    \label{fig:MiddleThreshold-C}
  }
  \subfloat[No Bunching in Year 4]{
    \includegraphics[width=60mm]{graphs/BunchingYear4_5Million_Degree4_30000}
    \label{fig:MiddleThreshold-D}
  }
  \hspace{0mm}
  \subfloat[No Bunching in Year 5]{   
    \includegraphics[width=60mm]{graphs/BunchingYear5_5Million_Degree4_30000}
...
\begin{figure}[t!]
  \centering
  \subfloat[Bunching in Year 1]{
    \includegraphics[width=60mm]{graphs/BunchingYear1_50Million_Degree4_3lac}
    \label{fig:HighestThreshold-A}
  }
  \subfloat[Bunching in Year 2]{
    \includegraphics[width=60mm]{graphs/BunchingYear2_50Million_Degree4_3lac}
    \label{fig:HighestThreshold-B}
  }
 \hspace{0mm}
  \subfloat[Bunching in Year 3]{
    \includegraphics[width=60mm]{graphs/BunchingYear3_50Million_Degree4_3lac}
    \label{fig:HighestThreshold-C}
  }
  \subfloat[No Bunching in Year 4]{
    \includegraphics[width=60mm]{graphs/BunchingYear4_50Million_Degree4_3lac}
...
\todo[inline, caption={Possible explanation}]{We should try and explain this better by suggesting that increased scrutiny could be one factor driving this.}
