...
%\scriptsize  
\begin{threeparttable}
\caption{Summary Statistics: Retailer and Wholesaler Sample}
...
\scalebox{0.9}{
\begin{threeparttable}
\caption{Diff-in-Diff: Wholesalers and Retailers (Annual, Top Percentile)}
...
\scalebox{0.9}{
\begin{threeparttable}
\caption{Diff-in-Diff: Wholesalers and Retailers (Annual, Bottom 99 Percentile)}
\begin{tabular}{llHllll} \hline
  \hline
 & (1) & (2) & (2) & (3) & (4) & (5)\\
  VARIABLES & Positive VAT  & VAT Remitted$>$ & VAT Remitted & Input Credit & Output Tax & Output Tax -\\
...
\begin{table}[t!]
    ...
    \scalebox{0.95}{
        \begin{threeparttable}
            \caption{Diff-in-Diff for Top Decile: Wholesalers and Retailers (Annual)}
...
\footnotesize
\scalebox{0.8}{
\caption{DiDiD: Wholesalers/Retailers; Before/After;Sales to Registered Firms}
\begin{threeparttable}
